    ...
    <div class="card mx-auto my-5 shadow-lg p-3 mb-5 bg-white rounded w-75">
        ...
        <div class="card-body">
            <form wire:submit.prevent="store">
                ...
                <div class="mb-3">
                    <label for="ambiente_id" class="form-label">Id do Ambi</label>
                    <input type="ambiente_id" class="form-control" id="ambiente_id" placeholder="Insira o ambiente_id do sensor" wire:model.defer="codigo">
                    @error('ambiente_id') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
